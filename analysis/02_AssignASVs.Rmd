...
##### THIS IS WHERE WE LEFT OFF 4/8/2026 !!!!!!!!!!!!!!!!!!!!!!!!!!!
...
write.table(final_ASV_table_withSeqs, 
            file = "data/Lecture/02_AssignASVs_Lecture/ASV_table_withSeqNames.tsv", 
            sep = "\t", quote = FALSE, col.names = NA)

# 2. Write count table with ASV numbered names (e.g. ASV_1, ASV_2, etc)
write.table(final_ASV_table, 
            file = "data/Lecture/02_AssignASVs_Lecture/ASV_table.tsv", 
            sep = "\t", quote = FALSE, col.names = NA)
```
...
write(ASV_fasta, "data/Lecture/02_AssignASVs_Lecture/ASVs.fasta")
```
...
write.table(ASV_tax_table, 
            file = "data/Lecture/02_AssignASVs_Lecture/ASV_taxonomy.tsv", 
            sep = "\t", quote = FALSE, col.names = NA)
```
...
save(track_counts_df, file = "data/Lecture/02_AssignASVs_Lecture/track_read_counts.RData")
```
...
save(raw_physeq, file = "data/Lecture/02_AssignASVs_Lecture/raw_physeq.RData")
```
