...
- `code/` – R scripts for QC, diversity, and differential abundance analysis.
- `metadata/` – Sample metadata files (no large raw sequence data).
- `results/` – Summary tables, figures, and small result files.
- `docs/` – Additional documentation and notes.

> Note: Raw sequence files (fastq, etc.) are **not** tracked in this repository and should be stored outside of Git.
